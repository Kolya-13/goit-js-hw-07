...
console.log(galleryBlockEl)

const makeGalleryMurkUp = ({ preview, original, description }) => {
...
console.log(makeGalleryMurkUp)

const makeGallery = galleryItems.map(makeGalleryMurkUp).join('')
...
// console.log('click')
onImgClick(e.target.dataset.source);
}
